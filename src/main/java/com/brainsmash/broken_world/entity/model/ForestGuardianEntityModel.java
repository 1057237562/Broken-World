...
public class ForestGuardianEntityModel<T extends ForestGuardianEntity> extends SinglePartEntityModel<T> {
    ...
    public ForestGuardianEntityModel(ModelPart root) {
        this.root = root;
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("head",
                ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -12.0F, -5.5F, 8.0F, 10.0F, 8.0F).uv(24, 0).cuboid(
                        -1.0F, -5.0F, -7.5F, 2.0F, 4.0F, 2.0F), ModelTransform.pivot(0.0F, -7.0F, -2.0F));
        modelPartData.addChild("body",
                ModelPartBuilder.create().uv(0, 40).cuboid(-9.0F, -2.0F, -6.0F, 18.0F, 12.0F, 11.0F).uv(0, 70).cuboid(
                        -4.5F, 10.0F, -3.0F, 9.0F, 5.0F, 6.0F, new Dilation(0.5F)),
