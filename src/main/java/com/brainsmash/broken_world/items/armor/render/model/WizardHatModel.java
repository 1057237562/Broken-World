...
public class WizardHatModel extends BipedEntityModel<LivingEntity> {
    ...
    public static ModelData getModelData(Dilation dilation, float pivotOffsetY) {
        ...
        modelPartData.addChild(EntityModelPartNames.HEAD,
                ModelPartBuilder.create().uv(53, 0).cuboid(-1.0F, -19.0F, 5.0F, 2.0F, 2.0F, 3.0F).uv(69, 1).cuboid(
                        -7.0F, -8.0F, -7.0F, 14.0F, 1.0F, 14.0F).uv(0, 13).cuboid(-5.0F, -11.0F, -5.0F, 10.0F, 3.0F,
                        10.0F).uv(0, 0).cuboid(-4.0F, -14.0F, -3.0F, 8.0F, 3.0F, 8.0F).uv(0, 27).cuboid(-3.0F, -17.0F,
