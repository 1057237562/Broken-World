...
public class HoeItem extends MiningToolItem {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        Pair<Predicate<ItemUsageContext>, Consumer<ItemUsageContext>> pair = (Pair) TILLING_ACTIONS.get(
    ...
    public static boolean canTillFarmland(ItemUsageContext context) {
        return context.getSide() != Direction.DOWN && context.getWorld().getBlockState(
                context.getBlockPos().up()).isAir();
    }

    static {
        TILLING_ACTIONS = Maps.newHashMap(ImmutableMap.of(Blocks.GRASS_BLOCK,
                Pair.of(net.minecraft.item.HoeItem::canTillFarmland,
                        createTillAction(Blocks.FARMLAND.getDefaultState())), Blocks.DIRT_PATH,
                Pair.of(net.minecraft.item.HoeItem::canTillFarmland,
                        createTillAction(Blocks.FARMLAND.getDefaultState())), Blocks.DIRT,
                Pair.of(net.minecraft.item.HoeItem::canTillFarmland,
                        createTillAction(Blocks.FARMLAND.getDefaultState())), Blocks.COARSE_DIRT,
                Pair.of(net.minecraft.item.HoeItem::canTillFarmland, createTillAction(Blocks.DIRT.getDefaultState())),
