...
public class CreativeGeneratorBlockEntityRenderer implements BlockEntityRenderer<CreativeGeneratorBlockEntity> {
    ...
    public CreativeGeneratorBlockEntityRenderer(BlockEntityRendererFactory.Context ctx){
        ...
        frame.scale(new Vec3f(-0.01f, -0.01f, -0.01f));
        shell = modelPart.getChild(SHELL);
        shell.scale(new Vec3f(-0.01f, -0.01f, -0.01f));
    ...
    public static TexturedModelData getTexturedModelData(){
        ...
        modelPartData.addChild(
                ...
                ModelPartBuilder
                        .create()
                        .uv(64, 0)
                        .cuboid(-8f, -8f, -8f, 16.0f, 16.0f, 16.0f),
        ...
        modelPartData.addChild(
                ...
                ModelPartBuilder
                        .create()
                        .uv(0, 34)
                        .cuboid(-4f, -4f, -4f, 8.0f, 8.0f, 8.0f),
                ModelTransform.pivot(8.0f, 8.0f, 8.0f)
        );
        modelPartData.addChild(
                INNER_ORB,
                ModelPartBuilder
                        .create()
                        .uv(0, 56)
                        .cuboid(-2f, -2f, -2f, 4.0f, 4.0f, 4.0f),
                ModelTransform.pivot(8.0f, 8.0f, 8.0f)
        );
