...
public class EntityRegister {
    ...
    public static final EntityType<BulletEntity> BULLET_ENTITY_ENTITY_TYPE = Registry.register(Registries.ENTITY_TYPE,
    ...
    public static final EntityType<HyperSpearEntity> HYPER_SPEAR_ENTITY_ENTITY_TYPE = Registry.register(
            Registries.ENTITY_TYPE, new Identifier(MODID, "hyper_spear"),
    ...
    public static final EntityType<FishboneEntity> FISHBONE_ENTITY_ENTITY_TYPE = Registry.register(
            Registries.ENTITY_TYPE, new Identifier(MODID, "fishbone"),
    ...
    public static final EntityType<GlitchedZombieEntity> GLITCHED_ZOMBIE_ENTITY_TYPE = Registry.register(
            Registries.ENTITY_TYPE, new Identifier(MODID, "glitched_zombie"),
    ...
    public static final EntityType<GlitchedSkeletonEntity> GLITCHED_SKELETON_ENTITY_TYPE = Registry.register(
            Registries.ENTITY_TYPE, new Identifier(MODID, "glitched_skeleton"),
    ...
    public static final EntityType<PhoenixEntity> PHOENIX_ENTITY_TYPE = Registry.register(Registries.ENTITY_TYPE,
    ...
    public static final EntityType<ApocalyptorEntity> APOCALYPTOR_ENTITY_TYPE = Registry.register(
            Registries.ENTITY_TYPE, new Identifier(MODID, "apocalyptor"),
    ...
    public static final EntityType<WerewolfEntity> WEREWOLF_ENTITY_TYPE = Registry.register(Registries.ENTITY_TYPE,
    ...
    public static final EntityType<DroneEntity> DRONE_ENTITY_TYPE = Registry.register(Registries.ENTITY_TYPE,
