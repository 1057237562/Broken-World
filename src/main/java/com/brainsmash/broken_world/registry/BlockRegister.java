...
public class BlockRegister {
    ...
    private static final AbstractBlock.Settings STANDARD_BLOCK = FabricBlockSettings.of(Material.METAL).sounds(BlockSoundGroup.METAL).strength(3.0f, 3.0f);
    ...
    public static final Block[] blocks = {
            ...
            new ChunkloaderBlock(STANDARD_BLOCK),
