...
public class AdvancedFurnaceGuiDescription extends SyncedGuiDescription {

    private static final int INVENTORY_SIZE = 23;
    private static final int PROPERTY_COUNT = 4;

    public AdvancedFurnaceGuiDescription(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
        super(Main.ADVANCED_FURNACE_GUI_DESCRIPTION,
                syncId,
                playerInventory,
        ...
        WBar bar1 = new WBar(new Identifier(Main.MODID, "textures/gui/progressbar.png"),
                new Identifier(Main.MODID, "textures/gui/progressbar_filled.png"),
                2,
                3,
                Direction.LEFT);
