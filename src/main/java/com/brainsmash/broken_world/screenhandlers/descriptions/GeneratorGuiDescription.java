...
public class GeneratorGuiDescription extends SyncedGuiDescription {
    ...
    public GeneratorGuiDescription(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
        ...
        WBar bar = new WBar(new Identifier(Main.MODID,"textures/gui/horizontal_electric_bar.png"),new Identifier(Main.MODID,"textures/gui/horizontal_electric_bar_filled.png"),0,1);
        bar.setProperties(propertyDelegate);
        root.add(bar, 5, 2,2,1);
        WItemSlot itemSlot = WItemSlot.of(blockInventory, 0);
        root.add(itemSlot, 3, 2);
        WBar bar1 = new WBar(new Identifier(Main.MODID,"textures/gui/fuel_slot.png"), new Identifier(Main.MODID,"textures/gui/fuel_slot_filled.png"),2,3);
