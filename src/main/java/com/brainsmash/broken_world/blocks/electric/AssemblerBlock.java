...
import com.brainsmash.broken_world.blocks.entity.electric.AssemblerBlockEntity;
...
public class AssemblerBlock extends ConsumerBlock {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        if (!world.isClient)
            return (world1, pos, state1, blockEntity) -> ((AssemblerBlockEntity) blockEntity).tick(world1, pos, state1,
