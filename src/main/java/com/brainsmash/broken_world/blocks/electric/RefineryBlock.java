...
import com.brainsmash.broken_world.blocks.entity.electric.RefineryBlockEntity;
...
public class RefineryBlock extends ConsumerBlock {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        if (!world.isClient)
            return (world1, pos, state1, blockEntity) -> ((RefineryBlockEntity) blockEntity).tick(world1, pos, state1,
