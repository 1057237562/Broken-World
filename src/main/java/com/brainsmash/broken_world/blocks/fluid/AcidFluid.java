...
public abstract class AcidFluid extends FluidModel {
    ...
    public Fluid getStill() {
        return Main.still_fluid[2];
    }

    @Override
    public Fluid getFlowing() {
        return Main.flowing_fluid[2];
    }

    @Override
    public Item getBucketItem() {
        return Main.bucket_item[2];
    }
    ...
    protected BlockState toBlockState(FluidState fluidState) {
        ...
        return Main.fluid_blocks[2].getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(fluidState));
    }
        ...
        if (direction == Direction.DOWN) {
            ...
            if(fluidState2.isIn(FluidTags.WATER)){
                if(state.getBlock() instanceof FluidBlock){
                    world.setBlockState(pos,Main.fluid_blocks[2].getDefaultState(),3);
                }
                return;
            }
        }
