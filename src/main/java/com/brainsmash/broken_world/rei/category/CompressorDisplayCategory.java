...
public class CompressorDisplayCategory implements DisplayCategory<CompressorDisplay> {
    @Override
    public CategoryIdentifier<? extends CompressorDisplay> getCategoryIdentifier() {
        return REIClient.COMPRESSOR_DISPLAY;
    }

    @Override
    public Text getTitle() {
        return Text.translatable("category.broken_world.compressor");
    }

    @Override
    public Renderer getIcon() {
        return EntryStacks.of(BlockRegister.blockitems[BlockRegistry.COMPRESSOR.ordinal()]);
    }
